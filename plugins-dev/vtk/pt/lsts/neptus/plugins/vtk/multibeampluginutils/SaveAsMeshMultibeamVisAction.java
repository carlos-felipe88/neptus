...
public class SaveAsMeshMultibeamVisAction extends VisualizationAction{
     ...
     * @param parent
     */
    public SaveAsMeshMultibeamVisAction(Vtk vtkMultibeamInit, Component parent, vtkPolyData polyData) {
        super(I18n.text("Save generated pointcloud mesh as..."), new ImageIcon(ImageUtils.getImage("images/menus/saveas.png")), I18n
                .text("Save a to mesh File"), KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.CTRL_DOWN_MASK, true));
