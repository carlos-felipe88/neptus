 ...
 * @author hfq
 * 
 *         #define VTK_CURSOR_DEFAULT 0 76 #define VTK_CURSOR_ARROW 1 77 #define VTK_CURSOR_SIZENE 2 78 #define
 *         VTK_CURSOR_SIZENW 3 79 #define VTK_CURSOR_SIZESW 4 80 #define VTK_CURSOR_SIZESE 5 81 #define
 *         VTK_CURSOR_SIZENS 6 82 #define VTK_CURSOR_SIZEWE 7 83 #define VTK_CURSOR_SIZEALL 8 84 #define VTK_CURSOR_HAND
 *         9 85 #define VTK_CURSOR_CROSSHAIR 10
 * 
 */
...
public class Vtk extends JPanel implements MRAVisualization, PropertiesProvider, ComponentListener {
    ...
    // @NeptusProperty(name = "Points to ignore on Multibeam 3D",
    // description="Fixed step of number of points to jump on multibeam Pointcloud stored for render purposes.")
    // public int ptsToIgnore = 100;
    // public int ptsToIgnore = NeptusMRA.ptsToIgnore;

    // @NeptusProperty(name = "Approach to ignore points on Multibeam 3D",
    // description="Type of approach to ignore points on multibeam either by a fixed step (false) or by a probability (true).")
    // public boolean approachToIgnorePts = true;
    // public boolean approachToIgnorePts = NeptusMRA.approachToIgnorePts;

    // @NeptusProperty(name = "Timestamp increment",
    // description="Timestamp increment for the 83P parser (in miliseconds).")
    // public long timestampMultibeamIncrement = 0;
    // public long timestampMultibeamIncrement = NeptusMRA.timestampMultibeamIncrement;

    // @NeptusProperty(name = "Yaw Increment",
    // description="Yaw (psi) increment for the 83P parser, set true to increment + 180º.")
    ...
    public void onCleanup() {
        /*
         * [xcb] Unknown sequence number while processing queue [xcb] Most likely this is a multi-threaded client and
         * XInitThreads has not been called [xcb] Aborting, sorry about that. java: ../../src/xcb_io.c:274:
