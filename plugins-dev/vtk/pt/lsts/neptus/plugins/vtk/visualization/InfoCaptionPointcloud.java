 ...
 *
 */
public class InfoCaptionPointcloud {
     ...
     * @param renderer
     */
    public InfoCaptionPointcloud(int xPosScreen, int yPosScreen, int numberOfPoints, String cloudName, double[] bounds, int memorySize) {
